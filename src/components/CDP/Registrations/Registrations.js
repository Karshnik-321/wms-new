...
import Datepicker from 'react-tailwindcss-datepicker';
  ...
  const stats = [
    ...
    { id: 2, name: 'Piano', subname: 'All Piano Users', stat: '53,917', substat: '53,917', icon: CursorArrowRippleIcon, change: '+54.02%', changeType: 'negative', bg: 'bg-green-50', iconcolor: 'text-green-500' },
                            ...
                            <dl className="grid grid-cols-1 lg:grid-cols-3">
                                {stats.map((item) => (
                                    ...
                                    >
                                        ...
                                        <div className='bottom-0 bg-opacity-25 ml-12 -mr-10 px-10 mt-4'>
